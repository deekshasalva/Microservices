...
namespace MT.OnlineRestaurant.BusinessLayer
{
    public class RestaurantBusiness : IRestaurantBusiness
    {
        ...
        public RestaurantBusiness(ISearchRepository _searchRepository,IMapper mapper)
        {
        ...
        public IQueryable<RestaurantInformation> SearchRestaurantByLocation(BusinessEntity.LocationDetails locationDetails)
        {
            try
            {
                ...
                foreach (var restaurants in searched_Restaurant)
                {
                    RestaurantInformation restaurant_Details = new RestaurantInformation
                    {
                        ...
                        restaurant_ContactNo = restaurants.restaurant_ContactNo,
